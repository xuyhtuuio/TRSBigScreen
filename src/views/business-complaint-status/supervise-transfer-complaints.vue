<template>
  <div class="supervise-transfer-cpmplaints">
    <p class="title-level2">监管转办投诉各业务占比</p>
    <div class="regCap">
      <div class="pie-box">
...
export default {
  ...
  methods: {
    ...
    initChart() {
      const data = [
        { name: '信用卡', value: 826506, pre: '' },
        { name: '借记卡', value: 110741, pre: '' },
        { name: '个人贷款', value: 1539570, pre: '' },
        { name: '理财类', value: 148555, pre: '' },
        { name: '其他零售', value: 48618, pre: '' },
        { name: '对公/小微', value: 27010, pre: '' }
      ]
