...
export default {
  ...
  mounted() {
    ...
    const dataTop = [
      [19985, 238738, 361900, 151594, 434141],
      [19765, 138738, 362900, 651594, 834141],
      [69985, 238738, 86900, 158794, 934141],
      [799285, 738738, 362900, 132594, 434141],
      [99765, 643738, 96900, 687594, 834141],
      [19985, 195738, 769200, 158794, 234141],
      [49985, 938738, 46900, 165594, 834141],
      [79765, 238738, 76900, 620594, 434141],
      [49985, 338738, 66900, 142794, 134141],
    ];
    // eslint-disable-next-line
    const dataDown = [
      [82285, 738738, 66900, 951594, 634141],
      [99765, 138738, 36900, 451594, 234141],
      [299385, 238738, 86900, 958794, 934141],
      [49985, 938738, 86900, 165594, 834141],
      [79765, 238738, 76900, 620594, 434141],
      [49985, 338738, 66900, 142794, 134141],
      [191985, 238738, 36900, 151594, 434141],
      [19765, 138738, 26900, 651594, 834141],
      [694985, 238738, 869200, 158794, 934141],
    ];
    /**
     * 初始化
     */
